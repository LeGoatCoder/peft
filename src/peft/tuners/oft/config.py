...
class OFTConfig(LycorisConfig):
    ...
    # The dropout probability for disabling OFT modules during training
    ...
    # List of modules apart from OFT layers to be set as trainable and saved in the final checkpoint. 
